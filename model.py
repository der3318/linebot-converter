...
from keras.layers import Embedding, LSTM, Input, TimeDistributed, Dense, dot, Activation, concatenate
...
class SequenceToSequenceModel():
    ...
    def saveWeights(self, filePath = "model.h5"):
        self.kerasOverallModel.save_weights(filePath)

    def loadWeights(self, filePath = "model.h5"):
